  ...
  return (
    <div className="overflow-hidden relative">
      ...
      <div className="absolute inset-0 flex items-center justify-between p-4">
        <button onClick={prev} className="p-1 rounded-full shadow bg-white/60 hover:bg-white">
          <img className="w-10" src="src\assets\Images\arrow.png"  />
        </button>
        <button onClick={next} className="p-1 rounded-full shadow bg-white/60 hover:bg-white">
