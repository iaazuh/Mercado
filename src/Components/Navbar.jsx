...
const Navbar = () => {
  ...
  return (
    <div className='flex item-center justify-between py-3 font-medium'>
      ...
      <img src="src\assets\Images\logo2-removebg-preview.png" className='w-36' alt="" />
      ...
      <div className='flex item-center gap-6'>
        <img className='w-auto h-5 cursor-pointer' src="src\assets\Images\searcher-removebg-preview.png" alt="" />        
        <div className='group relative'>
          <img className='w-auto h-5 cursor-pointer' src="src\assets\Images\user-removebg-preview.png" alt="" />
        ...
        <NavLink to='/cart' className='relative  pr-5'>
          ...
          <p className='absolute bottom-[1px] w-4 text-center leading-4 bg-red-500 text-white aspect-square rounded-full text-[8px]'>10</p>
        </NavLink>
