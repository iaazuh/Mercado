...
const Orders = () => {
  ...
  return (
    <div className='border-t pt-16 px-4 sm:px-[5vw] md:px[7vw] lg:px[9vw] bg-gray-100'>
                ...
                <div className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4' key={index}>
                  <div className="flex item-start gap-6 text-sm">
                    ...
                    <div>
                      ...
                      <p className='mt-2'>Date: <span className='text-gray-400'>24th July 2024</span></p>
                    </div>
                  </div>
                  <div className="md:w-1/2 flex justify-between">
                     <div className="flex item-center gap-2">
                        <p className='min-w-2 h-2 mt-1 rounded-full bg-green-500'></p>
